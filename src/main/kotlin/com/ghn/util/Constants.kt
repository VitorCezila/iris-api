...
object Constants {
    ...
    const val DEFAULT_NOTIFICATION_PAGE_SIZE = 15
    ...
    const val DEFAULT_PROFILE_PICTURE_PATH = "${BASE_URL}profile_pictures/profile.svg"
    const val DEFAULT_BANNER_IMAGE_PATH = "${BASE_URL}profile_pictures/background.jpg"
}